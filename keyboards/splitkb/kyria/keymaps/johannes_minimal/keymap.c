...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [GDN] = LAYOUT(
      KC_ESC , KC_SCLN, KC_COMM, KC_DOT , KC_P   , KC_Y   ,                                          KC_F   , KC_G   , KC_C   , KC_R   , KC_L   , KC_GRV ,
      KC_LSFT, KC_A   , KC_O   , KC_E   , KC_U   , KC_I   ,                                          KC_D   , KC_H   , KC_T   , KC_N   , KC_S   , KC_RSFT,
      KC_LCTL, KC_QUOT, KC_Q   , KC_J   , KC_K   , KC_X   , KC_B   , KC_M   ,      _______, _______, KC_B   , KC_M   , KC_W   , KC_V   , KC_Z   , KC_RCTL,
                                 _______, _______, _______, _______, _______,      _______, _______, _______, _______, _______
    ),
    ...
    [GDM] = LAYOUT(
      ...
      KC_LCTL, _______, _______, KC_F6  , KC_F5  , KC_F9  , _______, _______,      _______, _______, _______, KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_RCTL,
                                 _______, _______, _______, _______, _______,      _______, _______, _______, _______, _______
    ),
